...
plt.title('Movie month average')
colors = ['skyblue','lightskyblue','lightblue','powderblue','paleturquoise', 'peachpuff', 'lightsalmon','lightcoral', 'salmon', 'darksalmon', 'pink','coral', 'tomato']
result_title = ['before 2019.08','2019.09','2019.10','2019.11','2019.12','2020.01','2020.02','2020.03','2020.04','2020.05','2020.06','2020.07','2020.08']
plt.ylim(0, 13)
plt.bar(result_title, result_ratio, color=colors)
plt.show()